# Question 1 : A – C, determine the output displayed by the lines of code.
...
# Question 2 : Use list methods to code below.
...
# Question 3 : Write the codes and precisely produce the output format below.
...
# Question 4 : Create/Make PE4_4.py to do the following:


grades = []                                          # a)Create an empty list

grades.append(90)                                    # b)Add grades
grades.append(55)
grades.append(82)
grades.append(33)
grades.append(70)

print("Current List:", grades)                       # c)Output: Current List: [90, 55, 82, 33, 70]

total = 0                                            # d)Compute total
for grade in grades:
    total += grade

average = total / len(grades)                        # e)Compute average

print(f"Average: {average:.2f}")                     # f)Output: Average: 66.00

grades = [grade for grade in grades if grade >= 60]  # g)Remove failing grades

print("Updated list:", grades)                       # h)Output: Updated list: [90, 82, 70]

updated_average = sum(grades) / len(grades)          # i)Compute updated average
...
# Question 5 : Requests a name from the user.

full_name = input("Enter the full name of your favorite US president:\n") # a)Prompt for name

first_name, last_name = full_name.split()                                 # b)Split into first and last names
